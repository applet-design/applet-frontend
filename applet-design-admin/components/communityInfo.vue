		...
		<view class="weui-form" style="padding-top: 10rpx; border-radius: 10rpx; box-shadow: 0 0 5rpx #CCCCCC;">
			...
			<view class="weui-cell weui-cell_active">
				...
				<view class="weui-cell__bd">
					<input class="weui-input" placeholder="请输入通知标题" @input="getTitle"/>
				</view>
			</view>
			<!-- 上传通知封面 -->
			...
			<view class="weui-cells weui-cells_after-title">
				<view class="weui-cell weui-cell_active">
					<view class="weui-cell__bd">
						<textarea maxlength="-1" class="weui-textarea" placeholder-class="weui-input_placeholder" placeholder="请输入通知内容" style="height: 100rpx;" @input="getNoticeInfo"></textarea>
						<view aria-role="option" title="字数统计" class="weui-textarea-counter">0/400</view>
					</view>
				</view>
			</view>
			<!-- 按钮 -->
